  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      if (!product.name || product._id !== productId) {
        ...
        setGroceryPrice(product.groceryPrice)
        setDiscountThreshold(product.discountThreshold)
      ...
      <FormContainer>
        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='groceryPrice'>
            ...
            <Form.Group controlId='discountThreshold'>
